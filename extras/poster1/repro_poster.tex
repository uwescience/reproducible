...
\begin{frame}[t]
  \begin{columns}[t]                % the [t] option aligns the column's content at the top
    ...
    \vskip 1ex \hskip 1.7in \framebox{\includegraphics[width=5.5in]{github2.png} }

    \vskip 1ex
    Figshare for digital publishing / DOIs:\\
    \vskip 1ex \hskip 1.7in
    \framebox{\includegraphics[width=5.5in]{figshare.png} }
    \vskip 1ex
    IPython / Sage notebooks:\\
    \vskip 1ex \hskip 1.7in
    \framebox{\includegraphics[width=5.5in]{ipython1.png} }
    \vskip 1ex
    SageMathCloud to execute notebooks:\\
    \vskip 1ex \hskip 1.7in
    \framebox{\includegraphics[width=5.5in]{sagemathcloud.png} }
    \vskip 1ex
    VisTrails for provenance tracking:\\
    \vskip 1ex \hskip 1.7in
    \framebox{\includegraphics[width=5.5in]{vistrails.png} }
    \vskip 1ex
    Open Notebook Science:\\
    \vskip 1ex \hskip 1.5in
    \framebox{\includegraphics[width=5.5in]{roberts.png} }
    \vskip 1ex
    ~
    \end{column}
